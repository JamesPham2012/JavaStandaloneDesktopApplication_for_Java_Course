...
public class Bullet_Multiplayer extends GameObj {
    ...
    public Bullet_Multiplayer(float x_c, float y_c, int Id) {
        x = x_c;
        x_b = x_c;
        y = y_c;
        y_b = y_c;
    ...
    public static void resetfakebase(){
        fakebase.x_b=MultiplayerGame.player.getX();
        fakebase.y_b=MultiplayerGame.player.getY();
    }
    ...
    public static void Bullet_Reallo(Vector<Bullet_Multiplayer> bullet_arr, float x_c, float y_c, float x_offset, float y_offset,int id) {
        ...
        loop:     while (BulletGen == 0) {
            ...
            bullet_arr.addElement(new Bullet_Multiplayer(x_c, y_c,x_offset,y_offset,id));// create a new bullet
    ...
    public void setMove() {                  //Furthermore edit bullet orbit here
        ...
        switch (moveId) {
            ...
            case -2://spin around host
                ...
                x_b=MultiplayerGame.player.getX();
                y_b=MultiplayerGame.player.getY();
