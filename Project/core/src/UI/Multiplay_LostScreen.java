...
public class Multiplay_LostScreen implements Screen {
    ...
    private Sound sound = Gdx.audio.newSound(Gdx.files.internal("Audio/Astronomia.mp3"));
    ...
    public Multiplay_LostScreen(final MainClass mainClass) {
        this.mainClass = mainClass;

        animation = GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("Gif/coffindance.gif").read());
        ...
        label = new Label("DEFEAT", textSkin);
