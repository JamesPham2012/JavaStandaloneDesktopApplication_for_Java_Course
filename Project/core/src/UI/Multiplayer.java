...
public class Multiplayer implements Screen {
    ...
    public Multiplayer(final MainClass mainClass){
        ...
        textfield = new TextField("Input server IP Address here: ", skin2);
        ...
        PlayButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                if(ServerIP.equals("") || ServerIP.equals("Input server IP Address here: ")){
    ...
    @Override
    public void show() {
        textfield.setText("Input server IP Address here: ");
